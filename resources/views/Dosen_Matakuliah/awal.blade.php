...
<div class="panel panel-default">
	<div class="panel-heading">
		<strong>Seluruh Data Dosen Pengajar</strong>
		<a href="{{ url('dosen_matakuliah/tambah') }}" class="btn btn-xs btn-primary pull-right"><i class="fa fa-plus"></i>Dosen dan Matakuliah</a>
